...
しかし、ディープなキャップフリークたちの間では、**「日本未発売の限定モデル」や「海外ショップ別注デザイン（通称：Exclusive）」**を海外から直接個人輸入することが密かな常識となっています。サイドパッチが入ったカスタムカラーの「59FIFTY」などは、日本では手に入らないか、入っても一瞬でプレミア価格になってしまうからです。

### 🚨 最初の難関：米国の公式ストアは日本に送れない
多くの人が最初に挫折するポイントとして、**New Eraの米国公式オンラインストア（NewEraCap.com）は、日本への直接配送を一切行っていません。** 

そこで本記事では、公式を迂回しつつ**「安全にニューエラを輸入できる」**非常に優秀なグローバルセレクトショップや専門店を厳選してご紹介します。レア度を優先する方のための中・上級者向けルートも併せて解説しています。
...
ここでは通常のモデルよりも、「Fear of God Essentials（FOG）」や「Off-White」など、**世界的ハイブランドとニューエラがコラボした限定アイテム**が主力の狙い目です。非常に競争率が高いですが、決済にあらかじめ日本の関税を組み込む（DDP）設定も可能で、ハイエンド層には欠かせないショップです。
...
アメリカの若者に大人気のライフスタイル通販サイト。一時期ほどの在庫数はありませんが、スポーツ特化の店にはない、**淡いパステルカラーや、アースカラー（ブラウン、グリーン等）の「UO別注ニューエラ」**が不定期にリリースされます。ファッションアイテムとして変化球のニューエラを取り入れたいタイミングにチェックしたいショップです。
...
Lidsなどで本場の限定キャップを購入する場合、**『Planet Express』**や**『Shipito』**といった転送サービスに登録し、アメリカ国内に「自分専用の受け取り住所（オレゴン州などの免税州がおすすめ）」を発行してもらいます。
