...
export default function AboutPage() {
    const sections = [
        ...
        },
        {
            ...
            content: '当サイトは、Skimlinksなどのアフィリエイトプログラムに参加しています。当サイトのリンクを経由してお買い物をされた場合、当サイトがアフィリエイト報酬を受け取ることがあります。なお、これによりお客様の購入価格が変わることはありません。アフィリエイト報酬は、サイトの運営・改善費用に充てています。',
        },
        {
            icon: '📧',
            title: 'お問い合わせ',
